...
public class C04_StringBuilderdeStringMethotları {
    public static void main(String[] args) {
        ...
        sb1.substring(5);
        System.out.println(sb1); // Java Candir bi değişiklik olmuyor

        // sb1= sb1.substring(5); / bunu kabul etmez

        System.out.println(sb1.compareTo(sb2)); // -32 aski değer farkından dolayı eşit değil ( C c)

        System.out.println(sb1.toString().equalsIgnoreCase(sb2.toString()));  // true

        // sb1 i stringe cevirdik string olunca eualsıgnırcase cagırdık sb2 de strınge cevirilence
        // büyük küçük harf duyarlılığını görmezden geldi
